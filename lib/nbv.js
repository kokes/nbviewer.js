var nbv = (function() {
    ...
    function render_ipynb(obj, t) {
        ...
        if (sett.nbformat > 3) {
            sett.lang = obj.metadata.kernelspec.language
        }
    ...
    function excount(cell, tin = true) {
    ...
    function handle_code(cell) {
        ...
        // if (sett.hasOwnProperty('lang'))
        code.setAttribute('class', 'language-' + sett.lang || cell.language)
